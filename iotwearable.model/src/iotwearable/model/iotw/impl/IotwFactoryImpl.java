...
public class IotwFactoryImpl extends EFactoryImpl implements IotwFactory {
	 ...
	 * <code>String</code> representation. The <code>Rectangle</code> is represented
	 * as "x,y,width,height". <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	/**
	 * <!-- begin-user-doc --> if idConnect is empty : name,type if idConnect not
	 * empty: name,type,idConnect <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	public Pin createPinFromString(EDataType eDataType, String initialValue) {
		...
		TypePin type = values[1].trim().equals(TypePin.IO.toString()) ? TypePin.IO
				...
				: values[1].trim().equals(TypePin.SDA.toString()) ? TypePin.SDA
				: values[1].trim().equals(TypePin.SCL.toString()) ? TypePin.SCL
				: values[1].trim().equals(TypePin.GND.toString())? TypePin.GND
				: values[1].trim().equals(TypePin.VIN.toString())? TypePin.VIN
				: values[1].trim().equals(TypePin.RESET.toString())? TypePin.RESET
				: null;
		if (type == null)
			return null;
		if (values.length == 2) {
