...
void stateEmergency()
{
  ...
  String urlGetEmergency = "http://192.168.1.17:3000/Emergency";
...
void stateListening()
{
  ...
  String urlListPatient = "http://192.168.1.17:3000/listPatient";
...
void stateRecovery()
{
  ...
  String urlGetRecovery = "http://192.168.1.17:3000/Recovery";
...
void stateFever()
{
  ...
  String urlGetFever = "http://192.168.1.17:3000/Fever";
...
void stateIncubation()
{
  ...
  String urlGetIncubation = "http://192.168.1.17:3000/Incubation";
